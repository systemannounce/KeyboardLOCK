...
unsigned char MatrixKey()
{
	...
	if(P1_6==0){Delay(20);while(P1_6==0);Delay(20);KeyNumber=24;}
	if(P1_5==0){Delay(20);while(P1_5==0);Delay(20);KeyNumber=34;}
	if(P1_4==0){Delay(20);while(P1_4==0);Delay(20);KeyNumber=44;}
